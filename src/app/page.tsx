...
export default function Home() {
  return (
    <main className="min-h-screen text-white morphing-bg">
      ...
      {/* Hero Section */}
      <ParallaxSection offset={0} className="h-screen flex items-center justify-center mobile-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="space-y-4 sm:space-y-6 animate-fade-in">
            <div className="space-y-2 sm:space-y-4">
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold gradient-text tracking-tight glow-text">
              ...
              <p className="text-sm sm:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed px-4">
                A passionate Software Developer and Cyber Security Specialist, dedicated to building secure and innovative solutions. Currently pursuing B.Tech in Computer Science with specialization in Cyber Security at Graphic Era Hill University.
              </p>
            </div>
            
            {/* Big Robot */}
            <div className="mobile-robot mx-auto floating-element pulse-ring">
              <BigRobot />
            </div>
            
            <div className="pt-4 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
              <a
      ...
      {/* About Section */}
      <ParallaxSection id="about" className="py-32" offset={30}>
...
I am a fast learner, constantly adapting to new technologies and tackling evolving security challenges in today’s dynamic digital landscape.              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
             ...
             {/* Projects Section */}
       <ParallaxSection id="projects" className="py-32" offset={30}>
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <h2 className="text-4xl sm:text-5xl font-bold mb-16 text-center gradient-text tracking-tight">
             Projects
           </h2>
       ...
       {/* Skills Section */}
       <ParallaxSection id="skills" className="py-32" offset={30}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl sm:text-5xl font-bold mb-16 text-center gradient-text tracking-tight">
            Skills & Expertise
          </h2>
